...
["F:contour(fn, {view='XY'}) --> nil|str"] = [[Проекция контуров функции fn(x,y). Проекции: XY, XZ, YZ, concat.]],
...
["F:setX(range_t) --> nil"] = [[Установить X диапазон.]],
["F:showX(pos_s|nil) --> nil"] = [[Установить положение оси X.]],
...
["F:setZ(range_t) --> nil"] = [[Установить Z диапазон.]],
["F:showZ(pos_s|nil) --> nil"] = [[Установить положение оси Z.]],
["F:logY(isLog) --> nil"]  = [[Измернить тип оси Y на логарифмический и обратно.]],
["F:showY(pos_s|nil) --> nil"] = [[Установить положение оси Y.]],
...
["F:setY(range_t) --> nil"] = [[Установить Y диапазон.]],
["F:logX(isLog) --> nil"]  = [[Изменить тип оси X на логарифмический и обратно.]],
["F:logZ(isLog) --> nil"]  = [[Изменить тип оси Z на логарифмический и обратно.]],
},
---------- bigint.lua ----------
bigint = {
