...
[" {n1, n2,..} --> new_A"]          = [[Krei malplenan tabelon. Dimensio estas tablo.]],
...
["F:addString(row_N, col_N, str) --> F"]   = [[Aldonu vorton ĉe donita pozicio.]],
["F:addPoint(x_d, y_d, char_s) --> F"]    = [[Aldonu punkton (x,y) per simbolo.]],
["F:addPose(row_N, col_N, char_s) --> F"]     = [[Aldonu signon ĉe la donita pozicio.]],
[" (width_N=75, height_N=23) --> new_F"] = [[Kreu novan diagramon.]],
["F:scale(factor_d, isDefault=false) --> F"] = [[Skali la diagramon rilate al la komenca grandeco.]],
["F:plot(...) --> F"]            = [[Montru argumentojn 't', 't1,t1', 'fn,nm', 'fn1,fn2' ktp.]],
["F:bar(t, vy=2, x_N=1) --> F"]   = [[Bardiagramo.Plot bar diargram for data. vy estas aŭ indekso en t aŭ tabelo de y-j.]],
...
["F:tplot(data_t, {yfix=false}) --> F"] = [[Vidigo de tabelaj datumoj, vi povas specifi la kolumnombrojn.]],
["F:contour(fn, {view='XY'}) --> F|str"] = [[Trovu konturojn de projekcio por funkcio fn(x,y). Vidoj: XY, XZ, YZ, XYZ.]],
},
---------- bigint.lua ----------
bigint = {
...
[":ref(src_t, begin_N=1, end_N=#t) --> new_R"] = [[Akiru referencon al la gamo de elementoj.]],
...
["E.blhInto[E2]"]         = [[Revenas funkcion por konverti geodeziajn koordinatojn de sistemo A al B per la Molodensky metodo.]],
[":fromENU(blRef_t, xyzRef_t, top_t) --> xyzObs_t"] = [[Akiru kartezajn koordinatojn de loka punkto en referenca kadro.]],
["E.xyzInto[E2]"]         = [[Revenas funkcion por konverti koordinatojn de sistemo A al B.]],
...
["Map(fn,inList_t) --> outList_t"]            = [[Taksi funkcion por ĉiu elemento de la tablo.]],
...
["M:copy()"]               = [[Krei kopion de la matrico.]],
...
--["comparison"]           = [[a==b, a~=b]],
[":givensRot(elt1_v, elt2_v) --> cos_d, sin_d, len_d"]    = [[Trovu parametrojn de Givens-rotacio (c,s,r).]],
...
[":ode45(fn, interval_t, y0, {dt,exit}) --> ys_t, yLast"] = [[Nombra solvo de ODE.
...
[":gammainc(x_d, order_N, type_s='lower') --> num"] = [[Nekompleta gamma funkcio, P (type=lower) or Q (type=upper).]],
...
[" (var) --> new_S"]                 = [[Kreu novan simbolan variablon.]],
