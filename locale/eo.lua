...
["F:setY(range_t) --> nil"] = [[Ĝisdatigu Y-aksan gamon.]],
["F:showY(pos_s|nil) --> nil"] = [[Difinu la pozicion de la Y-akso.]],
["F:axes() --> tbl"]       = [[Akiru informojn {size, log, range, pose} por ĉiu akso.]],
["F:setX(range_t) --> nil"] = [[Ĝisdatigu X-aksan gamon.]],
["F:showX(pos_s|nil) --> nil"] = [[Difinu la pozicion de la X-akso.]],
["F:title(str) --> nil"]   = [[Agordu novan titolon.]],
["F:logY(isLog) --> nil"]  = [[Logaritma skalo sur la Y-akso.]],
[" (width_N=73, height_N=21) --> new_F"] = [[Kreu novan diagramon.]],
["F:showZ(pos_s|nil) --> nil"] = [[Difinu la pozicion de la Z-akso.]],
["F:logX(isLog) --> nil"]  = [[Logaritma skalo sur la X-akso.]],
["F:setZ(range_t) --> nil"] = [[Ĝisdatigu Z-aksan gamon.]],
["Plot(...) --> nil"]      = [[Montru argumentojn 't', 't1,t1', 'fn,nm', 'fn1,fn2' ktp]],
["F:logZ(isLog) --> nil"]  = [[Logaritma skalo sur la Z-akso.]],
