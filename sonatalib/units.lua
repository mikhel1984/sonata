...
--  @release This file is a part of <a href="https://github.com/mikhel1984/lc">sonatalib</a> units._collection, 2017-2018.
...
units.__add = function (U1,U2)
   ...
   local tmp = assert(units._unitConvert(U2,U1.key), "Different units!")
