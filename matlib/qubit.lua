...
qgate.isUnitary = function (self)
  if not self._mat then return false end
  local U = self._mat * self._mat:H()
...
qgate.matrix = function (self) return self._mat:copy() end


--- Make phase shift.
--  @param phase Shift value.
--  @param ... Indexes.
--  @return updated gate.
